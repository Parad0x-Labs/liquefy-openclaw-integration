...
For legally binding terms, see:

- `./LICENSE`

For a commercial summary and contact details, see:
...
This file provides a short, discoverable pointer for operators and integrators (including plugin developers) who need to quickly understand where to find:
